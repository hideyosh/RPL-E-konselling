            ...
            <div class="p-1.5 min-w-full inline-block align-middle">
                ...
                <table class="min-w-full divide-y divide-gray-200 ">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Pengaduan</th>
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 ">{{ $pengaduans->firstItem() + $loop->index }}</td>
                        <td class="first-letter:uppercase px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $pengaduan->isi_pengaduan }}</td>
                        <td class="capitalize px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $pengaduan->siswa->nama }}</td>
