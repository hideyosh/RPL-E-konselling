        ...
        <div class="p-6">
          ...
          <form action="{{ route('guru.laporan.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 md:grid-rows-3 gap-7">
            ...
            <div class="md:col-span-2 flex justify-end">
              <a href="{{ route('guru.laporan.index') }}"  class="inline-block mr-2 py-2.5 px-12 text-sm font-medium rounded-2xl bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Back
              </a>
